...
process 'create_BWA_ref' {
    ...
    conda '/Users/limc8h/conda_env/mpraflow_py36_minimal'
...
if (params.fastq_insertPE_file != null) {
    process 'align_BWA_PE' {
        ...
        shell:
            """
            bwa mem -B 100 -O 100 -E 100 -L 100  $design $chunk | \
    ...
    process 'align_BWA_S' {
        ...
        shell:
            """
            bwa mem -B 100 -O 100 -E 100 -L 100  $design $chunk | samtools sort - -o ${name}.${chunk}.sorted.bam
            echo 'bam made'
            samtools view ${name}.${chunk}.sorted.bam | head
